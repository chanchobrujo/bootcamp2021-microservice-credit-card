package com.everisbootcamp.creditcard.Constant.Paths;

import com.everisbootcamp.creditcard.Constant.Constan;
...
public enum Path {
    ...
    public static class URLS {
        ...
        private static final String HTTP_CONSTANT = "http".concat(Constan.DOUBLE_POINT).concat(Constan.DOUBLE_SLASH);
